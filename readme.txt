...
**Version 1.4.1-alpha2 (2016/04/06)**
...
(2016/04/06) Added a check for an installed version not included by the chosen version filter, to allow downgrading from a development version to an earlier stable version.
