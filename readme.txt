...
**Version 1.12.0-dev.1 (2018/09/30)**

* *New Features*
	* None.
* *Improvements*
	* Added a success notice after clicking the "Check for Updates" button.
* *Bugfixes*
	* None.
* *Developer Notes*
	* None.
...
(2018/09/30) Added a success notice after clicking the "Check for Updates" button.
